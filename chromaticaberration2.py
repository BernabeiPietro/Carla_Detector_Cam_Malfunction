...
if __name__ == '__main__':
    ...
    directory='/home/andrea/camera-kitti/KITTI/training/augmentedTest/normal/image_2/'
    ...
    for filename in os.listdir(directory):
        if filename.endswith(".png"):
            ...
            #1, blur
            #2, blur
            im = add_chromatic(im, strength=1, no_blur=False)# metodo da invocare per aggiungere effetto
            ...
            imOriginal.save(os.path.join("/home/andrea/camera-kitti/KITTI/training/augmentedTest/nochrom1withblur2",filename))
