...
\begin{comment}
L’attivazione avviene tramite funzioni matematiche. Il motivo principale è che in reti neurali profonde, il gradiente
...
\caption{Esempio di pooling con uno strinformatde e una dimensione del filtro pari a due.}
\label{fig:pooling}
\end{figure}
...
\label{tab:struttRete}
\end{table}

La rete impiegata per il progetto è stata sviluppata in python, impiegando la libreria Tensorflow nella versione 1.14.
La sua struttura ha la forma definita nella tabella \ref{tab:struttRete}
...
& \multicolumn{2}{|c|}{Train} & \multicolumn{2}{|c}{Validation} \\ \hline\hline
Classi & train loss & train acc & val loss & val acc\\
Blur 3.5 & 2,26E-12 & 1 & 1,97E-12 & 1\\
...
chromaticaberrration&2,96E-17&1,0,1\\
rain&1,58E-16&1&5,03E-28&1\\
all&0,0996&0,9358&0,0965&0,9337\\
\hline
\end{tabular}
\caption{Tabella dei risultati della fase di training e validation}
\label{tab:Risultati training}
\end{table}
...
di overfitting.\cite{guyon1997scaling}.

Per la fase di training, sono state eseguite 5 epoch con batch di dimensione 4.
E'  stata impiegata come metrica, Accuracy mentre come funzione di loss, BinaryCrossentropy
I risultati sia della fase del training sia della validation sono mostrati nella tabella \ref{tab:Risultati training}
Da questi primi risultati si può notare come in generale la rete dia ottimi risultati su tutte le classi in questa fase.
Le uniche classi dove questi risultati non sono ottimali sono: 200 death pixel e 50 death pixel. Su queste due si può assumere che l'agente non riesca ad identificare le differenze tra golden run e guasto.
...
Ottenuto 17 reti istruite ciascuna sul proprio dataset di dati, la fase finale del progetto è verificare la loro effettiva efficacia su due set di immagini e  verificare l'assenza di overfitting negli  agenti.
Per ciascuna rete sono stati impiegati due differenti test set:
\begin{itemize}
\item golden run-singolo guasto
\item golden run e i restanti guasti-singolo guasto
\end{itemize}
Quest'ultimo avendo sempre 14400 elementi, risulta essere  sbilanciato, avendo nella prima classe un numero superiore della seconda.
Per una prima fase di testing le metriche usate sono sempre le stesse della fase di training ovvero Accuracy e BinaryCrossentropy.
I risultati ottenuti sono mostrati alla seguente Tabella \ref{tab:testing1}
\begin{table}[]
\centering
\caption{Tabella riassuntiva della prima fase di testing}
\label{tab:testing1}
\begin{tabular}{l|cc|cc}
\hline
                     & \multicolumn{2}{|c|}{singola classe} & \multicolumn{2}{|c}{all} \\ \hline\hline
classi               & loss              & acc            & loss         & acc      \\
Blur 3.5             & 1,79E-20          & 1              & 1,92E+03     & 0,5708   \\
black                & 1,97E-16          & 1              & 7,76E+02     & 0,5417   \\
brightness           & 8,41E+02          & 0.5            & 5,65E+02     & 0,442    \\
50 death pixels      & 0,6932            & 0,5            & 0,6932       & 0,5      \\
200 death pixels     & 0,6932            & 0,5            & 0,6932       & 0,5      \\
nodemos              & 3,98E-35          & 1              & 7,30E+01     & 0,5833   \\
noise                & 4,13E-12          & 1              & 4,02E+01     & 0,5833   \\
sharpness            & 3,4551            & 0,9763         & 2,63E+02     & 0,6072   \\
brokenlens           & 2,10E-07          & 1              & 3,05E+01     & 0,5417   \\
icelens              & 2,6259            & 0,8182         & 5817,3185    & 0,5595   \\
banding              & 6,7391            & 0,5469         & 7197,409     & 0,3942   \\
greyscale            & 1,02E+00          & 0,8938         & 3,76E+01     & 0,5      \\
condensation         & 1,36E-01          & 0,998          & 2,36E+02     & 0,5247   \\
dirty lens           & 18,5961           & 0,58           & 31,0586      & 0,5076   \\
chromaticaberrration & 0,00E+00          & 1              & 4719,5721    & 0,5625   \\
rain                 & 5,15E+00          & 0,8819         & 6,97E+01     & 0,5188   \\
all                  &                   &                & 668,9222     & 0,5      \\ \hline
\end{tabular}
\end{table}
Si può notare da quest'ultima che per 200 e 50 death pixels, le affermazioni espresse in precedenza sono confermate siccome effettivamente l'agente "tira ad indovinare" l'appartenenza di un dato ad una determinata classe.
