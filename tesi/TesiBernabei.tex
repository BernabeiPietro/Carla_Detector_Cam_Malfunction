...
Una rete neurale convuluzionale è una rete neurale di tipo feed-forward network che impiega un operazione matematica chiamata \textbf{convuluzione}.
...
\subparagraph{Convulutional Layer:}
Layer impiegati anche come layer di input, ricevono 
