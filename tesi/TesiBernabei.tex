...
\end{itemize}
\subparagraph{La sicurezza (safety)} è poi l’assenza di conseguenze catastrofiche sugli
...
l’affidabilità).
\subparagraph{La sicurezza (security)} può quindi essere vista come la contemporanea esistenza di availability solo per gli utenti autorizzati, confidentiality, e
